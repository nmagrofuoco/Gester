 ...
 */
 ...
 /**
  * TODO This file was modified to parametrize the nbr of resampling points
  * "resample_cnt" was added as a parameter of all 3 functions
  */
 ...
 */
jackknife_blades.prototype.set_ip_defaults = function(resample_cnt) {
    this.resample_cnt = resample_cnt;
    this.radius = 2;
 ...
 */
jackknife_blades.prototype.set_ed_defaults = function(resample_cnt) {
    this.resample_cnt = resample_cnt;
    this.radius = 2;
    this.euclidean_distance = 1;
    this.z_normalize = 1;
